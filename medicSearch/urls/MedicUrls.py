...
from medicSearch.views.MedicView import list_medics_view, add_favorite_view, remove_favorite_view, rate_medic, edit_address
...
urlpatterns = [
    ...
    path("address/<int:address_id>", edit_address, name='edit-address-medic')
]
